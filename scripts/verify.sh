...
echo "内容页产物："
COUNT=$(find out \( -path "*/intro/*" -o -path "*/guides/*" -o -path "*/items/*" -o -path "*/collectibles/*" -o -path "*/maps/*" \) -name "*.html" | wc -l)
find out \( -path "*/intro/*" -o -path "*/guides/*" -o -path "*/items/*" -o -path "*/collectibles/*" -o -path "*/maps/*" \) -name "*.html" | sort
if [ "$COUNT" -eq 0 ]; then
