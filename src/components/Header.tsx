...
export function Header() {
  // 扬哥 2026-09-11 定标（样板v2 硬条款7）：顶栏只留 游戏名(左) + View on Steam(右)。
  // 旧横向导航、Home 按钮、Play Now 全部移除；Steam 按钮不叫 Play Now（避免"点了就能玩"的误导）。
  // 2026-09-15 youtube-video-wiki 同步该定标（halloween 按钮事故后对齐）。
  return (
